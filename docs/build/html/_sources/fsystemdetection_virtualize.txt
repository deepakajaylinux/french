...
Enfin, après détection de l'information au sujet de ce qui précède mentionné caractéristiques sont clairement signalés. La capture d'écran suivante représente l'utilisateur concernant le processus de détection du système.
...
* Les utilisateurs peuvent configurer les paramètres d'application à l'aide de détections de ce système. 
* Les paramètres utilisés pour déclarer la commande help, détection des systems sont le non respect de la casse qui un avantage supplémentaire   alors que par rapport aux autres. 
