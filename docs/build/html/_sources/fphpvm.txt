...
Ce module agit comme facilitateur pour l'installation et la mise à jour ainsi que la VM de php avec la dernière version. Voyons sur l'utilisation de ce module et les façons d'utiliser ce module dans les sujets à venir.

Commande Aide
--------------------

La commande help guide les utilisateurs au sujet de l'objet et ainsi que sur les options qui sont inclus dans le module Phpvm. Il énumère les alternatives aux paramètres du module Phpvm. Il décrit également la syntaxe pour l'installation du module Phpvm. La commande d'aide pour le module Phpvm est représentée ci-dessous.
...
La syntaxe pour déclarer la commande d'aide ne est pas sensible à la casse qui est un avantage supplémentaire. La capture d'écran ci-dessous vous visualiser sur la commande d'aide en vertu Phpvm.
...
La commande utilisée pour installer le phpvm dans la machine des utilisateurs est indiqué ci-dessous:
...
.. cssclass:: table-bordered
 ...
 +======================+===========================================+==============+===============================================+
 |Install PHPVM? (Y/N)  | Au lieu de phpvm, nous pouvons utiliser   | Y(Yes)       | Si l'utilisateur souhaite procéder le         |
 |                      | PHPVM, Phpvm également.                   |              | processus d'installation qu'ils peuvent       |
 |                      |                                           |              | entrée comme Y.                               |
 +----------------------+-------------------------------------------+--------------+-----------------------------------------------+
 |Install PHPVM? (Y/N)  | Au lieu de phpvm, nous pouvons utiliser   | N(No)        | Si l'utilisateur souhaite quitter le          | 
 |                      | PHPVM, Phpvm également.                   |              | processus d'installation qu'ils peuvent       |
 |                      |                                           |              | entrée comme N|                               | 
 +----------------------+-------------------------------------------+--------------+-----------------------------------------------+
...
* Ce module de volonté installe le phpvm dans la version mise à jour.
