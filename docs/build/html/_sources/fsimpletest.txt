...
SimpleTest est une unité de source ouverte d'essai cadre pour le langage de programmation PHP. Cadre de SimpleTest permet à faire rapidement de tests unitaires et eassily. SimpleTest prend en charge les objets simulacres et peut être utilisé pour automatiser les tests de régression des applications web avec un HTTP Client scriptable qui peuvent analyser les pages HTML et simuler des choses comme en cliquant sur les liens et formulaires.

Commande Aide
----------------

Cette commande permet de déterminer l'utilisation de simpletest. Il énumère les paramètres alternatifs de simpletest. Il décrit également la syntaxe pour le fonctionnement du module de simpletest. La commande help pour simpletest est montrée ci-dessous.
...
La commande utilisée pour l'installation du module de simpletest sur le terminal est répertoriée ci-dessous,
...
La commande utilisée pour désinstaller le module de simpletest sur le terminal est répertoriée ci-dessous,
...
* Il est facile de séparer les épreuves et les ont exécutés 
* contribue à faciliter le développement de test rapide 
* nécessaire pour tester l'interface web 
* permet au développeur de distinguer facilement ce qui est faux
