...
Il crée des modèles drupal installer construction. L'utilisateur peut ajouter d'autres modèles . Lorsque nous apportons des changements à l'utilisateur référentiel , le déploiement d'une nouvelle version à la Production d'utilisateur cible . La commande utilisée pour builderfy est la suivante ,
