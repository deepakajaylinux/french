...
.. cssclass:: table-bordered
 ...
 +=====================================+===========+================================================================+
 |Configure Environments Here? (Y/N)   | Y         | Si l'utilisateur souhaite configurer les environnements        |
 |                                     |           | à l' environnement actuel ils peuvent d'entrée comme Y         |
 +-------------------------------------+-----------+----------------------------------------------------------------+
 |Configure Environments Here? (Y/N)   | N         | Si l'utilisateur ne souhaite pas configurer les environnements |
 |                                     |           | à l' environnement actuel ils peuvent d'entrée comme N         |
 +-------------------------------------+-----------+----------------------------------------------------------------+
 |Use existing environment             | Y         | Si l'utilisateur souhaite utiliser les paramètres              |
 |settings? (Y/N)                      |           | d'environnement existantes qu'ils peuvent entrée comme Y.      |
 +-------------------------------------+-----------+----------------------------------------------------------------+
 |Use existing environment             | N         | Si l'utilisateur ne souhaite pas utiliser les paramètres       |
 |settings? (Y/N)                      |           | d'environnement existantes qu'ils peuvent entrée comme N.      |
 +-------------------------------------+-----------+----------------------------------------------------------------+
 |Do you want to add another           | Y         | Si l'utilisateur souhaite ajouter un autre environnement,      |
 |environment? (Y/N)                   |           |  ils peuvent entrée comme Y.                                   |
 +-------------------------------------+-----------+----------------------------------------------------------------+
 |Do you want to add another           | N         | Si l'utilisateur ne souhaite pas ajouter  un autre             |
...
* Ce module conduit les utilisateurs à configurer l'environnement , comment supprimer l'environnement indésirables , la façon d'utiliser   
