...
Tracelytics est la solution SaaS performances de l'application qui comprend architectures Web évolutives . Effacer les frontières entre les applications, les couches et les machines ; commencer à tracer . Tracelytics offre une visibilité sur complexes , applications web Distribué par la collecte d'informations sur les performances et le comportement des demandes à travers des couches logicielles et les machines. Tracelytics est une application complète de traçage de la pile pour le cloud et distribués applications dans #Java , #PHP , #Ruby et #Python , aidant #devops de performance d'esprit et d'autres . Trace tout.


Commande Aide
----------------

La commande help guide les utilisateurs au sujet de l'objet et ainsi que sur les options qui sont inclus dans le module tracelytics . Il décrit également la syntaxe pour l'installation du module de tracelytics . La commande d'aide pour le module de tracelytics est représentée ci-dessous .
...
La commande utilisée pour installer le module tracelytics sur le terminal est listé ci-dessous ,
...
* Visualiser les modèles de demande en un seul endroit pour séparer le bruit de la systématique.
* Trace chaque machine impliquée dans la transaction et identifier les goulots d'étranglement en un seul clic .
* Croix - hôte, transaction distribuée traçage
* Suivi réel de l'utilisateur , etc ..
