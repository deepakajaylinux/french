...
Wireframing est une étape importante dans tout processus de conception de l'écran. Il vous permet principalement de définir la hiérarchie de l'information de votre conception, ce qui rend plus facile pour vous de planifier la mise en page en fonction de la façon dont vous voulez que votre utilisateur de traiter les informations.

Wireframing est importante car elle permet au concepteur de planifier la mise en page et l'interaction d'une interface sans être distrait par des couleurs, des choix typographiques ou même copie. Je aime à expliquer à mes clients que si un utilisateur ne peut pas comprendre où aller sur un fil de fer noir et blanc, il n'a pas d'importance ce que les couleurs que vous utilisez éventuellement. Un bouton doit être évident, même si elle ne est pas brillant ou de couleur vive.

Commande Aide
----------------------

Cette commande vous permet d'installer filaire Sketcher, pour Wireframing. L'utilisateur viendra à connaître les différentes façons / format à exécuter ce module. Cette commande guide l'utilisateur final de connaître le but de cette commande. Ci-dessous sont donnés la commande et la capture d'écran de la même.
...
Lorsque l'utilisateur doit installer filaire Sketcher dans la machine. Ci-dessous sont donnés la commande et la capture d'écran du processus d'installation.
...
.. cssclass:: table-bordered
 ...
 +===========================+==================================================+==========+===============================================+
 |ptconfigure                | Chacun des deux paramètre alternatif peut être   | Y        | Une fois que l'utilisateur fournit l'option,  |
 |WireframeSketcher          | utilisé dans la commandeWireframeSketcher,       |          | système démarre processus d'installation      |
 |install?(Y/N)              | wireframe-sketcher, wireframesketcher par        |          |                                               |
 |                           | exemple: ptconfigure wireframe-sketcher Install  |          |                                               |
 +---------------------------+--------------------------------------------------+----------+-----------------------------------------------+
 |ptconfigure                | Chacun des deux paramètre alternatif peut être   | N        | Une fois que l'utilisateur fournit l'option,  |
 |WireframeSketcher          | utilisé dans la commandeWireframeSketcher,       |          | système arrête processus d'installation       |
 |install?(Y/N)              | wireframe-sketcher, wireframesketcher par        |          |                                               |
 |                           | exemple: ptconfigure wireframe-sketcher Install| |          |                                               |
 +---------------------------+--------------------------------------------------+----------+-----------------------------------------------+
...
* La gamme de fonctions disponibles
* Les priorités relatives de l'information et de fonctions
* Les règles d'affichage de certains types d'informations
* L'effet de différents scénarios sur l'écran
