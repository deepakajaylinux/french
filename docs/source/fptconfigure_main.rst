...
cette commande va lister tous les noms des modules qui sont disponibles en vertu ptconfigure.
ici, la capture d'écran représente l'affichage de tous les modules disponibles sous ptconfigure.
...
cette commande permettra l'utilisation de ce module particulier et aussi les options disponibles dans les actions que vous pouvez effectuer.
Explique l'utilisation du module Behat sous ptconfigure aide de la commande d'aide de la capture d'écran ci-dessous.
