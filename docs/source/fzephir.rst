...
Zephir - Ze ( nd Moteur ) Ph ( p ) I ( nt ) r ( médiation ) - est un langage de haut niveau qui facilite la création et la maintenabilité des extensions de PHP . Zephir extensions sont exportés au code C qui peut être compilé et optimisé par les principaux compilateurs C tels que gcc / bruit / vc ++ . La fonctionnalité est exposé au langage PHP . Zephir est une source ouverte et permet aux développeurs de haut niveau font extensions PHP bas niveau .

Commande Aide
---------------

Cette commande décrit l'utilisation du module de zephir . Il énumère les paramètres de Zephir et la syntaxe pour le fonctionnement du module de zephir . le aide commande pour le module zephir est représentée ci-dessous ,
...
La commande utilisée pour l'installation du module de zephir sur le terminal est listé ci-dessous ,
...
* Zephir offre des avantages à la fois compilé ainsi que langage interprété
* La sécurité de la mémoire
* Les deux typage dynamique / statique, etc ..
