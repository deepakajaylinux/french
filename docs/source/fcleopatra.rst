...
  Cette commande d'aide de guider l'utilisateur à propos de Cleopatra. Convient à tous les types d'utilisateurs. Il dépeint les autres paramètres et commandes pour l'installation. La commande d'aide suivant la capture d'écran et aideront l'utilisateur concernant l'utilisation.
...
-------------
              
  Ce est un processus de plus simple à installer le module de Cléopâtre en utilisant simplement la commande ci-dessous,
...
* Cleopatra est utilisé pour installer le fichier de configuration. Lors de l'installation se il ya ne importe quel fichier existant est 
