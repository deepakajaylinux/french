...
Cette commande permet de déterminer l'utilisation de KVM . Il énumère les autres paramètres de KVM . Il décrit également la syntaxe
pour le fonctionnement du module KVM . La commande d'aide pour kvm est représentée ci-dessous .
...
* Réduction des coûts
* Performance de l'entreprise et l'évolutivité supérieur
* Sécurité avancée
