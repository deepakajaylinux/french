...
Zend Server est une plate-forme d'application conçu pour exécuter des applications PHP plus rapide et meilleure échelle sur site ou dans le nuage - privé, public ou hybride.

Zend Server est disponible en tant que plateforme de développement pour créer des applications de qualité plus élevés qui peuvent être déployées sur un serveur; et une plate-forme de production pour exécuter des applications essentielles à la mission qui exigent une haute performance et d'évolutivité.

Zend Server est la plate-forme qui permet livraison continu, ce qui assure la cohérence, de l'automatisation et de collaboration capacités au long du cycle de livraison d'applications. Ce est un, Oracle-permis, Web Application Server complète prête pour l'entreprise pour les applications PHP qui nécessitent un haut niveau de fiabilité, de performance et de sécurité en cours d'exécution et de gestion.


Commande Aide
----------------------

Cette commande permet de déterminer l'utilisation de module de serveur Zend. L'utilisateur viendra à savoir sur la manière différente / format à exécuter ce module. Cette commande guide l'utilisateur final de connaître le but de cette commande. Ci-dessous sont donnés la commande et la capture d'écran de la même.
...
Cette commande aide à l'installation dans le système zendserver. Si dans le cas zendserver déjà disponibles dans le système, cette commande met à jour la version. La commande ci-dessous donnée exécuter le processus d'installation
...
.. cssclass:: table-bordered
 ...
 +=========================+==========================================================+==============+====================================+
 |ptconfigure zendserver   | Il ya trois paramètres alternatifs qui peuvent être      | Y            | Le système démarre processus       |
 |Install? (Y/N)           | utilisés en ligne de commande. zendserver, Zendserver,   |              | d'installation                     |
 |                         | ZendServer par exemple: ptconfigure zendserver           |              |                                    |
 |                         | install ptconfigure Zendserver install                   |              |                                    |
 +-------------------------+----------------------------------------------------------+--------------+------------------------------------+
 |ptconfigure zendserver   | Il ya trois paramètres alternatifs qui peuvent être      | N            | Système arrête processus           |
 |Install? (Y/N)           | utilisés en ligne de commande. zendserver, Zendserver,   |              | d'installation                     |
 |                         | ZendServer par exemple: ptconfigure zendserver           |              |                                    |
 |                         | install ptconfigure Zendserver install|                  |              |                                    |
 +-------------------------+----------------------------------------------------------+--------------+------------------------------------+
...
* Ultime débogage de code, des requêtes, des spécificités et cadres
* Suivi complet et l'analyse des causes
* Amélioration de code et les performances des applications
* Facile à installer, entretenir et pré-installé dans le nuage
* Processus de déploiement manuel ou automatique
* Évolutivité dynamique Vrai et une plus grande disponibilité
* La pile de PHP ne certifié et entièrement pris en charge
